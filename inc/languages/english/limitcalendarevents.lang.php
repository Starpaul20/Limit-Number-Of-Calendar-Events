...
$l['maxeventsday'] = "Maximum Calendar Events allowed Per Day";
$l['maxeventsday_desc'] = "Maximum number of calendar events users in this group can post in a day. If empty, users can post an unlimited number of events.";
